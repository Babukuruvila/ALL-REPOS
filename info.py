...
BOT_TOKEN = environ.get('BOT_TOKEN', '6460431508:AAHEebfr31hyqOvURvm99ge9BaeB1LFWFjM')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001539643863 -1001207313685 -1001172622040 -1001532592684 -1001523987925 -1001829635869 -1002238146620').split()]
...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://pvrcine:pvrcine@cluster0.8mgl5qp.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://pvr:pvr@cluster0.uhkizwn.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Nathalia")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# FSUB
auth_channel = environ.get('AUTH_CHANNEL', '-1002244425244')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
# Set to False inside the bracket if you don't want to use Request Channel else set it to Channel ID
REQ_CHANNEL = environ.get("REQ_CHANNEL", "-1002244425244")
